...
#define ERROR_MSG(msg) buildMsg(msg, __FILE__, __LINE__)
    ...
    InferResult inferArithmetic      (Operator const &, TensorRefs, InferOptions const&); computation::SharedOp lowerArithmetic (Operator const &, TensorRefs);
    InferResult inferCast            (Operator const &, TensorRefs, InferOptions const&); computation::SharedOp lowerCast       (Operator const &, TensorRefs);
    InferResult inferCompair         (Operator const &, TensorRefs, InferOptions const&); computation::SharedOp lowerCompair    (Operator const &, TensorRefs);
    InferResult inferConcat          (Operator const &, TensorRefs, InferOptions const&); computation::SharedOp lowerConcat     (Operator const &, TensorRefs);
    ...
    InferResult inferReduce          (Operator const &, TensorRefs, InferOptions const&); computation::SharedOp lowerReduce     (Operator const &, TensorRefs);
    InferResult inferReshape         (Operator const &, TensorRefs, InferOptions const&); computation::SharedOp lowerReshape    (Operator const &, TensorRefs);
    InferResult inferSelect          (Operator const &, TensorRefs, InferOptions const&); computation::SharedOp lowerSelect     (Operator const &, TensorRefs);
    InferResult inferSlice           (Operator const &, TensorRefs, InferOptions const&); computation::SharedOp lowerSlice      (Operator const &, TensorRefs);
    InferResult inferSoftmax         (Operator const &, TensorRefs, InferOptions const&); computation::SharedOp lowerSoftmax    (Operator const &, TensorRefs);
    InferResult inferSplit           (Operator const &, TensorRefs, InferOptions const&); computation::SharedOp lowerSplit      (Operator const &, TensorRefs);
